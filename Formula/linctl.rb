class Linctl < Formula
  ...
  homepage "https://github.com/nicholls-inc/linctl"
  url "https://github.com/nicholls-inc/linctl/archive/refs/tags/v0.1.0.tar.gz"
  sha256 "7aea99cc1bee2f097020930e0cc9e7a575340ab4969e81d673299a60ad586874"
  license "MIT"
  head "https://github.com/nicholls-inc/linctl.git", branch: "master"

  depends_on "go" => :build

  def install
    system "go", "build", *std_go_args(ldflags: "-s -w -X github.com/nicholls-inc/linctl/cmd.version=#{version}")
  end
